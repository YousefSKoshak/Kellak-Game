        ...
        with self.game_manager.lock:
            ...
            for room_id in self.db_manager.get_all_room_ids():
                ...
                if player_to_update:
                    ...
                    # If in waiting phase, mark as disconnected with short rejoin window
                    if room["phase"] == "waiting":
                        ...
                        # Clean up any players whose window has expired
                        current_time = time.time()
                        expired_players = [p for p in room["players"]
                                        if p.get("disconnected") and (current_time - p.get("disconnect_time", 0)) > 60]
                        ...
                        # If host disconnected, assign new host from active players
